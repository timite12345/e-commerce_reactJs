...
<body>
    ...
    <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <button ><i class="fa fa-chevron-right"><FontAwesomeIcon icon={faChevronLeft} /></i></button>
        </a>
        <a class="carousel-control-next text-decoration-none w-auto pe-3" href="#template-mo-zay-hero-carousel" role="button" data-bs-slide="next">
        <button ><i class="fa fa-chevron-right"><FontAwesomeIcon icon={faChevronRight} /></i></button>
        </a>
    </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                                    <i class="text-warning fa fa-star"><FontAwesomeIcon icon={faStar} /></i>
                                    <i class="text-warning fa fa-star"><FontAwesomeIcon icon={faStar} /></i>
                                    <i class="text-warning fa fa-star"><FontAwesomeIcon icon={faStar} /></i>
                                    <i class="text-muted fa fa-star"><FontAwesomeIcon icon={faStar} /></i>
                                    <i class="text-muted fa fa-star"><FontAwesomeIcon icon={faStar} /></i>
                                </li>
